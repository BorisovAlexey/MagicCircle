namespace Zenject
{
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TValue>, IFactory<TParam1, TValue>
    {
        ...
        protected virtual void Reinitialize(TParam1 screenPosition, TValue item)
        {
            // Optional
        }
        ...
        : MemoryPoolBase<TValue>, IMemoryPool<TParam1, TParam2, TValue>, IFactory<TParam1, TParam2, TValue>
    {
        ...
        protected virtual void Reinitialize(TParam1 screenPosition, TParam2 p2, TValue item)
        {
            // Optional
        }
