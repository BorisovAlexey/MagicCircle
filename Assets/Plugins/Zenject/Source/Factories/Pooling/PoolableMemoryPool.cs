namespace Zenject
{
        ...
        where TValue : IPoolable<TParam1>
    {
        ...
        protected override void Reinitialize(TParam1 screenPosition, TValue item)
        {
            item.OnSpawned(screenPosition);
        }
    }
        ...
        where TValue : IPoolable<TParam1, TParam2>
    {
        ...
        protected override void Reinitialize(TParam1 screenPosition, TParam2 p2, TValue item)
        {
            item.OnSpawned(screenPosition, p2);
        }
    }
